                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php
                                $availability_status = ($row['quantity'] > 0) ? 'Available' : 'Out of stock';
                                $badge_class = ($row['quantity'] > 0) ? 'badge-success' : 'badge-secondary';
                                ?>
                                <td class="text-center"><span class="badge <?php echo $badge_class ?>"><?php echo $availability_status ?></span></td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
